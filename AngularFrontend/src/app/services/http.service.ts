...
http=inject(HttpClient)
  ...
  getDepartments(filter:any)
  {
    ...
    return this.http.get<PagedData<IDepartment>>(environment.apiUrl + '/api/Department?',{params}  );
  }
  ...
  {
    return this.http.put(environment.apiUrl+'/api/Department/'+id,{name:name,});
  ...
  getEmployeeList(filter:any)
  {
    ...
    return this.http.get<PagedData<IEmployee>>(environment.apiUrl+'/api/Employee?'+params.toString());
  }
